...
Two parts, both required - about a minute. MIT licensed, 40 tools, runs on your own machine. [Full install guide →](/docs/install-claude-code) · [Or install browsermcp.io if that's the right call for you](https://browsermcp.io) - we mean that.
